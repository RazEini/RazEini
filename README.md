...
### 🧠 Smart Task Flow
**Smart Android task manager with automated prioritization**  
- Jetpack Compose UI  
- MVVM architecture  
- Rule-based task prioritization  

**Tech:** Kotlin, Firebase  
🔗 https://github.com/RazEini/Smart_Task_Flow  

---

### 🛒 E-Commerce Shop
**Full Android store app with admin panel and live cart**  
- User authentication  
...
🔗 https://github.com/RazEini/smart_chat_bot  

---

### 🔐 Password Manager
**Encrypted password vault with CLI & GUI**  
- AES-128-GCM encryption  
- Password strength validation  
- Secure local storage  

**Tech:** Python  
🔗 https://github.com/RazEini/Password_Manager  
...
[![Resume](https://img.shields.io/badge/Resume-PDF-2EA44F?style=for-the-badge&logoColor=white)](https://github.com/RazEini/RazEini/raw/main/RazEini_resume.pdf)
